...
AS
	...
	WHERE Classification IN ('house - semi-detached', 'flat', 'flat/unit/apartment', 'house', 'apartment', 'house - terrace', 'townhouse', 'strata unit/flat', 'villa', 'unit', 'house - duplex', 'residential warehouse', 'stratum flat', 'stratum unit', 'house & granny flat')
		AND Suburb IN
		(
			SELECT Suburb
			FROM cte_UnionWithoutDuplicates
